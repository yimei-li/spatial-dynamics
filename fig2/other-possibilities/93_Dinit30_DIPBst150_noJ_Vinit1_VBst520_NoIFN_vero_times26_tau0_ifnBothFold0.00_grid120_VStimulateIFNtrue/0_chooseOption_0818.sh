...
burstSizeV=520 # 790                  # Virion burst size - USER SUGGESTED: increased to 200 for exponential growth
burstSizeD=150  # 100                  # DIP burst size (increased to make distribution difference more visible)
...
meanLysisTime=7.5             # Mean infection duration - USER SUGGESTED: increased for stability (was 15h)
...
dipRadius=30                  # Absolute DIP spread radius for bursts (cells)
...
unexposedAreaFraction=0.20


unexposedSetAreaFraction=0.0
