...
burstSizeV=550 # 790                  # Virion burst size - USER SUGGESTED: increased to 200 for exponential growth
burstSizeD=120  # 100                  # DIP burst size (increased to make distribution difference more visible)
